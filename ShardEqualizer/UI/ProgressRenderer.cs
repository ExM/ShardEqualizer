...
public class ProgressRenderer: IProgressCollector, IAsyncDisposable
{
	...
	public IProgressReporter Start(string title, long total = 0, Func<long, string> valueRenderer = null)
	{
